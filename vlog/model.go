...
// It can be set via the Level optional parameter to ConfigureLogging.
...
// It can be set via the StderrThreshold optional parameter to ConfigureLogging.
// It implements the flag.Value interface to support command line option parsing.
...
// It can be set via the ModuleSpec optional parameter to ConfigureLogging.
// It implements the flag.Value interface to support command line option parsing.
...
// It can be set via the TraceLocation optional parameter to ConfigureLogging.
// It implements the flag.Value interface to support command line option parsing.
