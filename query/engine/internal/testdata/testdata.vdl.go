...
func __VDLRead1_set(dec vdl.Decoder, x *map[Tdh]struct{}) error {
	...
	case len == 0:
		*x = nil
		return dec.FinishValue()
	case len > 0:
		*x = make(map[Tdh]struct{}, len)
	default:
		*x = make(map[Tdh]struct{})
	}
	for {
		switch done, err := dec.NextEntry(); {
		case err != nil:
...
func __VDLRead5_map(dec vdl.Decoder, x *map[int16][]map[string]struct{}) error {
	...
	case len == 0:
		*x = nil
		return dec.FinishValue()
	case len > 0:
		*x = make(map[int16][]map[string]struct{}, len)
	default:
		*x = make(map[int16][]map[string]struct{})
	}
	for {
		switch done, err := dec.NextEntry(); {
		case err != nil:
...
func __VDLRead8_map(dec vdl.Decoder, x *map[bool]string) error {
	...
	case len == 0:
		*x = nil
		return dec.FinishValue()
	case len > 0:
		*x = make(map[bool]string, len)
	default:
		*x = make(map[bool]string)
	}
	for {
		switch done, err := dec.NextEntry(); {
		case err != nil:
...
func __VDLRead9_map(dec vdl.Decoder, x *map[byte]string) error {
	...
	case len == 0:
		*x = nil
		return dec.FinishValue()
	case len > 0:
		*x = make(map[byte]string, len)
	default:
		*x = make(map[byte]string)
	}
	for {
		switch done, err := dec.NextEntry(); {
		case err != nil:
...
func __VDLRead10_map(dec vdl.Decoder, x *map[uint16]string) error {
	...
	case len == 0:
		*x = nil
		return dec.FinishValue()
	case len > 0:
		*x = make(map[uint16]string, len)
	default:
		*x = make(map[uint16]string)
	}
	for {
		switch done, err := dec.NextEntry(); {
		case err != nil:
...
func __VDLRead11_map(dec vdl.Decoder, x *map[uint32]string) error {
	...
	case len == 0:
		*x = nil
		return dec.FinishValue()
	case len > 0:
		*x = make(map[uint32]string, len)
	default:
		*x = make(map[uint32]string)
	}
	for {
		switch done, err := dec.NextEntry(); {
		case err != nil:
...
func __VDLRead12_map(dec vdl.Decoder, x *map[uint64]string) error {
	...
	case len == 0:
		*x = nil
		return dec.FinishValue()
	case len > 0:
		*x = make(map[uint64]string, len)
	default:
		*x = make(map[uint64]string)
	}
	for {
		switch done, err := dec.NextEntry(); {
		case err != nil:
...
func __VDLRead13_map(dec vdl.Decoder, x *map[int16]string) error {
	...
	case len == 0:
		*x = nil
		return dec.FinishValue()
	case len > 0:
		*x = make(map[int16]string, len)
	default:
		*x = make(map[int16]string)
	}
	for {
		switch done, err := dec.NextEntry(); {
		case err != nil:
...
func __VDLRead14_map(dec vdl.Decoder, x *map[int32]string) error {
	...
	case len == 0:
		*x = nil
		return dec.FinishValue()
	case len > 0:
		*x = make(map[int32]string, len)
	default:
		*x = make(map[int32]string)
	}
	for {
		switch done, err := dec.NextEntry(); {
		case err != nil:
...
func __VDLRead16_map(dec vdl.Decoder, x *map[float32]string) error {
	...
	case len == 0:
		*x = nil
		return dec.FinishValue()
	case len > 0:
		*x = make(map[float32]string, len)
	default:
		*x = make(map[float32]string)
	}
	for {
		switch done, err := dec.NextEntry(); {
		case err != nil:
...
func __VDLRead17_map(dec vdl.Decoder, x *map[float64]string) error {
	...
	case len == 0:
		*x = nil
		return dec.FinishValue()
	case len > 0:
		*x = make(map[float64]string, len)
	default:
		*x = make(map[float64]string)
	}
	for {
		switch done, err := dec.NextEntry(); {
		case err != nil:
...
func __VDLRead19_map(dec vdl.Decoder, x *map[string]map[string]string) error {
	...
	case len == 0:
		*x = nil
		return dec.FinishValue()
	case len > 0:
		*x = make(map[string]map[string]string, len)
	default:
...
func __VDLRead20_map(dec vdl.Decoder, x *map[time.Time]string) error {
	...
	case len == 0:
		*x = nil
		return dec.FinishValue()
	case len > 0:
		*x = make(map[time.Time]string, len)
	default:
		*x = make(map[time.Time]string)
	}
	for {
		switch done, err := dec.NextEntry(); {
		case err != nil:
...
func __VDLRead21_set(dec vdl.Decoder, x *map[bool]struct{}) error {
	...
	case len == 0:
		*x = nil
		return dec.FinishValue()
	case len > 0:
		*x = make(map[bool]struct{}, len)
	default:
		*x = make(map[bool]struct{})
	}
	for {
		switch done, err := dec.NextEntry(); {
		case err != nil:
...
func __VDLRead24_set(dec vdl.Decoder, x *map[uint32]struct{}) error {
	...
	case len == 0:
		*x = nil
		return dec.FinishValue()
	case len > 0:
		*x = make(map[uint32]struct{}, len)
	default:
		*x = make(map[uint32]struct{})
	}
	for {
		switch done, err := dec.NextEntry(); {
		case err != nil:
...
func __VDLRead26_set(dec vdl.Decoder, x *map[int16]struct{}) error {
	...
	case len == 0:
		*x = nil
		return dec.FinishValue()
	case len > 0:
		*x = make(map[int16]struct{}, len)
	default:
		*x = make(map[int16]struct{})
	}
	for {
		switch done, err := dec.NextEntry(); {
		case err != nil:
...
func __VDLRead29_set(dec vdl.Decoder, x *map[float32]struct{}) error {
	...
	case len == 0:
		*x = nil
		return dec.FinishValue()
	case len > 0:
		*x = make(map[float32]struct{}, len)
	default:
		*x = make(map[float32]struct{})
	}
	for {
		switch done, err := dec.NextEntry(); {
		case err != nil:
...
func __VDLRead31_set(dec vdl.Decoder, x *map[time.Time]struct{}) error {
	...
	case len == 0:
		*x = nil
		return dec.FinishValue()
	case len > 0:
		*x = make(map[time.Time]struct{}, len)
	default:
		*x = make(map[time.Time]struct{})
	}
	for {
		switch done, err := dec.NextEntry(); {
		case err != nil:
