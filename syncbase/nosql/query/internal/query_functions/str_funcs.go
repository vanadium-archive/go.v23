...
func str(db query.Database, off int64, args []*query_parser.Operand) (*query_parser.Operand, error) {
	o := args[0]
...
func htmlEscapeFunc(db query.Database, off int64, args []*query_parser.Operand) (*query_parser.Operand, error) {
...
func htmlUnescapeFunc(db query.Database, off int64, args []*query_parser.Operand) (*query_parser.Operand, error) {
	strOp, err := conversions.ConvertValueToString(args[0])
	if err != nil {
		return nil, err
	}
...
func lowerCase(db query.Database, off int64, args []*query_parser.Operand) (*query_parser.Operand, error) {
	strOp, err := conversions.ConvertValueToString(args[0])
	if err != nil {
		return nil, err
	}
...
func upperCase(db query.Database, off int64, args []*query_parser.Operand) (*query_parser.Operand, error) {
	strOp, err := conversions.ConvertValueToString(args[0])
	if err != nil {
		return nil, err
	}
...
func typeFunc(db query.Database, off int64, args []*query_parser.Operand) (*query_parser.Operand, error) {
...
func typeFuncFieldCheck(db query.Database, off int64, args []*query_parser.Operand) error {
	...
	if args[0].Type != query_parser.TypField || len(args[0].Column.Segments) < 1 || args[0].Column.Segments[0].Value != "v" {
		return query.NewErrArgMustBeField(db.GetContext(), args[0].Off)
	}
	return nil
}
...
func split(db query.Database, off int64, args []*query_parser.Operand) (*query_parser.Operand, error) {
...
func sprintf(db query.Database, off int64, args []*query_parser.Operand) (*query_parser.Operand, error) {
...
func strCat(db query.Database, off int64, args []*query_parser.Operand) (*query_parser.Operand, error) {
	val := ""
...
func strIndex(db query.Database, off int64, args []*query_parser.Operand) (*query_parser.Operand, error) {
...
func strLastIndex(db query.Database, off int64, args []*query_parser.Operand) (*query_parser.Operand, error) {
	s, err := conversions.ConvertValueToString(args[0])
	if err != nil {
		return nil, err
	}
...
func strRepeat(db query.Database, off int64, args []*query_parser.Operand) (*query_parser.Operand, error) {
	s, err := conversions.ConvertValueToString(args[0])
	if err != nil {
		return nil, err
	}
...
func strReplace(db query.Database, off int64, args []*query_parser.Operand) (*query_parser.Operand, error) {
	s, err := conversions.ConvertValueToString(args[0])
	if err != nil {
		return nil, err
	}
...
func trim(db query.Database, off int64, args []*query_parser.Operand) (*query_parser.Operand, error) {
	s, err := conversions.ConvertValueToString(args[0])
	if err != nil {
		return nil, err
	}
...
func trimLeft(db query.Database, off int64, args []*query_parser.Operand) (*query_parser.Operand, error) {
	s, err := conversions.ConvertValueToString(args[0])
	if err != nil {
		return nil, err
	}
...
func trimRight(db query.Database, off int64, args []*query_parser.Operand) (*query_parser.Operand, error) {
	s, err := conversions.ConvertValueToString(args[0])
	if err != nil {
		return nil, err
	}
