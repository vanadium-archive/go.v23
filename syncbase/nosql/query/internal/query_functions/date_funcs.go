...
func checkIfPossibleThatArgIsConvertibleToLocation(db query.Database, arg *query_parser.Operand) error {
	...
	case query_parser.TypBigInt, query_parser.TypBigRat, query_parser.TypBool, query_parser.TypComplex, query_parser.TypFloat, query_parser.TypInt, query_parser.TypStr, query_parser.TypTime, query_parser.TypUint:
		if locStr, err = conversions.ConvertValueToString(arg); err != nil {
			if err != nil {
				return query.NewErrLocationConversionError(db.GetContext(), arg.Off, err)
			} else {
				return nil
			}
		}
...
func timeFunc(db query.Database, off int64, args []*query_parser.Operand) (*query_parser.Operand, error) {
...
// now()
func now(db query.Database, off int64, args []*query_parser.Operand) (*query_parser.Operand, error) {
	return makeTimeOp(off, time.Now()), nil
}
func timeInLocation(db query.Database, off int64, args []*query_parser.Operand) (time.Time, error) {
...
func year(db query.Database, off int64, args []*query_parser.Operand) (*query_parser.Operand, error) {
...
func month(db query.Database, off int64, args []*query_parser.Operand) (*query_parser.Operand, error) {
	if tim, err := timeInLocation(db, off, args); err != nil {
		return nil, err
	} else {
...
func day(db query.Database, off int64, args []*query_parser.Operand) (*query_parser.Operand, error) {
	if tim, err := timeInLocation(db, off, args); err != nil {
		return nil, err
	} else {
...
func hour(db query.Database, off int64, args []*query_parser.Operand) (*query_parser.Operand, error) {
	if tim, err := timeInLocation(db, off, args); err != nil {
		return nil, err
	} else {
...
func minute(db query.Database, off int64, args []*query_parser.Operand) (*query_parser.Operand, error) {
	if tim, err := timeInLocation(db, off, args); err != nil {
		return nil, err
	} else {
...
func second(db query.Database, off int64, args []*query_parser.Operand) (*query_parser.Operand, error) {
	if tim, err := timeInLocation(db, off, args); err != nil {
		return nil, err
	} else {
...
func nanosecond(db query.Database, off int64, args []*query_parser.Operand) (*query_parser.Operand, error) {
	if tim, err := timeInLocation(db, off, args); err != nil {
		return nil, err
	} else {
...
func weekday(db query.Database, off int64, args []*query_parser.Operand) (*query_parser.Operand, error) {
	if tim, err := timeInLocation(db, off, args); err != nil {
		return nil, err
	} else {
...
func yearDay(db query.Database, off int64, args []*query_parser.Operand) (*query_parser.Operand, error) {
	if tim, err := timeInLocation(db, off, args); err != nil {
		return nil, err
	} else {
...
func secondArgLocationCheck(db query.Database, off int64, args []*query_parser.Operand) error {
