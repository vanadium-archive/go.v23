...
func lenFunc(db query.Database, off int64, args []*query_parser.Operand) (*query_parser.Operand, error) {
	switch args[0].Type {
	...
	return nil, query.NewErrFunctionLenInvalidArg(db.GetContext(), args[0].Off)
}
