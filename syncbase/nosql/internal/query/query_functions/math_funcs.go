...
func ceilingFunc(db query_db.Database, off int64, args []*query_parser.Operand) (*query_parser.Operand, error) {
...
func floorFunc(db query_db.Database, off int64, args []*query_parser.Operand) (*query_parser.Operand, error) {
	f, err := conversions.ConvertValueToFloat(args[0])
	if err != nil {
		return nil, err
	}
...
func isNanFunc(db query_db.Database, off int64, args []*query_parser.Operand) (*query_parser.Operand, error) {
	f, err := conversions.ConvertValueToFloat(args[0])
	if err != nil {
		return nil, err
	}
...
func isInfFunc(db query_db.Database, off int64, args []*query_parser.Operand) (*query_parser.Operand, error) {
	f, err := conversions.ConvertValueToFloat(args[0])
	if err != nil {
		return nil, err
	}
...
func logFunc(db query_db.Database, off int64, args []*query_parser.Operand) (*query_parser.Operand, error) {
	f, err := conversions.ConvertValueToFloat(args[0])
	if err != nil {
		return nil, err
	}
...
func log10Func(db query_db.Database, off int64, args []*query_parser.Operand) (*query_parser.Operand, error) {
	f, err := conversions.ConvertValueToFloat(args[0])
	if err != nil {
		return nil, err
	}
...
func powFunc(db query_db.Database, off int64, args []*query_parser.Operand) (*query_parser.Operand, error) {
...
func pow10Func(db query_db.Database, off int64, args []*query_parser.Operand) (*query_parser.Operand, error) {
...
func modFunc(db query_db.Database, off int64, args []*query_parser.Operand) (*query_parser.Operand, error) {
	x, err := conversions.ConvertValueToFloat(args[0])
	if err != nil {
		return nil, err
	}
...
func truncateFunc(db query_db.Database, off int64, args []*query_parser.Operand) (*query_parser.Operand, error) {
	f, err := conversions.ConvertValueToFloat(args[0])
	if err != nil {
		return nil, err
	}
...
func remainderFunc(db query_db.Database, off int64, args []*query_parser.Operand) (*query_parser.Operand, error) {
	x, err := conversions.ConvertValueToFloat(args[0])
	if err != nil {
		return nil, err
	}
...
func realFunc(db query_db.Database, off int64, args []*query_parser.Operand) (*query_parser.Operand, error) {
