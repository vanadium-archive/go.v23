...
func ServiceClient(name string, opts ...ipc.BindOpt) ServiceClientStub {
...
func (c implServiceClientStub) c(ctx *context.T) ipc.Client {
	if c.client != nil {
		return c.client
	}
...
// Service methods, as expected by ipc.Server.
...
func (s implServiceServerStub) Globber() *ipc.GlobState {
	return s.gs
}

func (s implServiceServerStub) Describe__() []ipc.InterfaceDesc {
	return []ipc.InterfaceDesc{ServiceDesc, object.ObjectDesc}
}

// ServiceDesc describes the Service interface.
var ServiceDesc ipc.InterfaceDesc = descService

// descService hides the desc to keep godoc clean.
var descService = ipc.InterfaceDesc{
	Name:    "Service",
...
func UniverseClient(name string, opts ...ipc.BindOpt) UniverseClientStub {
	var client ipc.Client
	for _, opt := range opts {
		if clientOpt, ok := opt.(ipc.Client); ok {
			client = clientOpt
...
func (c implUniverseClientStub) c(ctx *context.T) ipc.Client {
	if c.client != nil {
		return c.client
	}
	return v23.GetClient(ctx)
...
// Universe methods, as expected by ipc.Server.
...
func (s implUniverseServerStub) Describe__() []ipc.InterfaceDesc {
	return []ipc.InterfaceDesc{UniverseDesc, object.ObjectDesc}
}

// UniverseDesc describes the Universe interface.
var UniverseDesc ipc.InterfaceDesc = descUniverse

// descUniverse hides the desc to keep godoc clean.
var descUniverse = ipc.InterfaceDesc{
	Name:    "Universe",
	PkgPath: "v.io/syncbase/v23/services/syncbase",
...
type DatabaseClientMethods interface {
	...
	UpdateSchema(ctx *context.T, schema Schema, etag string, opts ...ipc.CallOpt) error
	// GetSchema returns the schema for this Database.
	GetSchema(*context.T, ...ipc.CallOpt) (schema Schema, etag string, err error)
}
...
func DatabaseClient(name string, opts ...ipc.BindOpt) DatabaseClientStub {
	var client ipc.Client
	for _, opt := range opts {
		if clientOpt, ok := opt.(ipc.Client); ok {
			client = clientOpt
...
func (c implDatabaseClientStub) c(ctx *context.T) ipc.Client {
	if c.client != nil {
		return c.client
	}
	return v23.GetClient(ctx)
...
// Database methods, as expected by ipc.Server.
...
func (s implDatabaseServerStub) Describe__() []ipc.InterfaceDesc {
	return []ipc.InterfaceDesc{DatabaseDesc, object.ObjectDesc}
}

// DatabaseDesc describes the Database interface.
var DatabaseDesc ipc.InterfaceDesc = descDatabase

// descDatabase hides the desc to keep godoc clean.
var descDatabase = ipc.InterfaceDesc{
	Name:    "Database",
	PkgPath: "v.io/syncbase/v23/services/syncbase",
...
func TableClient(name string, opts ...ipc.BindOpt) TableClientStub {
	var client ipc.Client
	for _, opt := range opts {
		if clientOpt, ok := opt.(ipc.Client); ok {
			client = clientOpt
...
func (c implTableClientStub) c(ctx *context.T) ipc.Client {
	if c.client != nil {
		return c.client
	}
	return v23.GetClient(ctx)
...
// Table methods, as expected by ipc.Server.
...
func (s implTableServerStub) Globber() *ipc.GlobState {
	return s.gs
}

func (s implTableServerStub) Describe__() []ipc.InterfaceDesc {
	return []ipc.InterfaceDesc{TableDesc}
}

// TableDesc describes the Table interface.
var TableDesc ipc.InterfaceDesc = descTable

// descTable hides the desc to keep godoc clean.
var descTable = ipc.InterfaceDesc{
	Name:    "Table",
	PkgPath: "v.io/syncbase/v23/services/syncbase",
...
type ItemClientMethods interface {
	...
	Get(*context.T, ...ipc.CallOpt) (*vdl.Value, error)
	// Put writes the given value for this Item. The value's primary key field
	// must match Item.Key().
	Put(ctx *context.T, value *vdl.Value, opts ...ipc.CallOpt) error
...
func ItemClient(name string, opts ...ipc.BindOpt) ItemClientStub {
	var client ipc.Client
	for _, opt := range opts {
		if clientOpt, ok := opt.(ipc.Client); ok {
			client = clientOpt
...
func (c implItemClientStub) c(ctx *context.T) ipc.Client {
	if c.client != nil {
		return c.client
	}
	return v23.GetClient(ctx)
...
// Item methods, as expected by ipc.Server.
...
func (s implItemServerStub) Describe__() []ipc.InterfaceDesc {
	return []ipc.InterfaceDesc{ItemDesc}
}

// ItemDesc describes the Item interface.
var ItemDesc ipc.InterfaceDesc = descItem

// descItem hides the desc to keep godoc clean.
var descItem = ipc.InterfaceDesc{
	Name:    "Item",
	PkgPath: "v.io/syncbase/v23/services/syncbase",
