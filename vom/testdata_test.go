...
var coderTests = []struct {
	...
	// Simple named types.
	{
		...
		//                     (NamedPrimitiveType.Name) "v.io/veyron/veyron2/vom.Uint"
		...
		"ff81161001310110766579726f6e322f766f6d2e55696e7400" +
			"ff820101",
		`["type","v.io/veyron/veyron2/vom.Uint uint"]
			["Uint",1]
			`,
		j{`1`},
	},
	...
	},
	{
		...
		//                     (SliceType.Name) "v.io/veyron/veyron2/vom.Slice"
		// 00                (SliceType end)
		//
		// ff82 03 020102    type 65[ff82] len[03] values 1,2[02 0102]
		"Slice",
		...
		"ff81171201310111766579726f6e322f766f6d2e536c69636500" +
			"ff8203020102",
		`["type","v.io/veyron/veyron2/vom.Slice []uint"]
			["Slice",[1,2]]
			`,
		j{`[1, 2]`},
	},
	{
		...
		//                     (SliceType.Name) "v.io/veyron/veyron2/vom.OuterSlice"
		// 00                (SliceType end)
		//
		...
		"ff811c1201420116766579726f6e322f766f6d2e4f75746572536c69636500" +
			...
			"ff820401020102",
		`["type","v.io/veyron/veyron2/vom.Slice []uint"]
			["type","v.io/veyron/veyron2/vom.OuterSlice []Slice"]
			["OuterSlice",[[1,2]]]
			`,
		j{`[[1, 2]]`},
	},
	...
	},
	{
		...
		//                     (ArrayType.Name) "v.io/veyron/veyron2/vom.Array"
		// 00                (ArrayType end)
		//
		// ff82 02 0102    type 65[ff82] len[02] values 1,2[0102]
		"Array",
		...
		"ff811914013101020111766579726f6e322f766f6d2e417272617900" +
			"ff82020102",
		`["type","v.io/veyron/veyron2/vom.Array [2]uint"]
			["Array",[1,2]]
			`,
		j{`[1, 2]`},
	},
	{
		...
		//                     (ArrayType.Name) "v.io/veyron/veyron2/vom.OuterArray"
		// 00                (ArrayType end)
		//
		// ff83 17           typedef 66[ff83] len[17]
		// 12                (SliceType)
		...
		"ff811e14014201010116766579726f6e322f766f6d2e4f75746572417272617900" +
			...
			"ff8203020102",
		`["type","v.io/veyron/veyron2/vom.Slice []uint"]
			["type","v.io/veyron/veyron2/vom.OuterArray [1]Slice"]
			["OuterArray",[[1,2]]]
			`,
		j{`[[1, 2]]`},
	},
	...
	},
	{
		...
		//                     (MapType.Name) "v.io/veyron/veyron2/vom.Map"
		// 00                (MapType end)
		//
		// ff82 0b 02        type 65[ff82] len[0b] len[02]
		//   01 03 616263      key 1[01] value "abc"[03 616263]
		...
		"ff81171601310103010f766579726f6e322f766f6d2e4d617000" +
			"ff820b02[0103616263,0203646566]",
		`["type","v.io/veyron/veyron2/vom.Map map[uint]string"]
			["Map",{"1":"abc","2":"def"}]
			`,
		j{`{"1": "abc", "2": "def"}`},
	},
	...
	},
	{
		...
		//                     (MapType.Name) "v.io/veyron/veyron2/vom.OuterMap"
		// 00                (MapType end)
		//
		// ff83 17           typedef 66[ff83] len[17]
		// 12                (SliceType)
		...
		`["type","v.io/veyron/veyron2/vom.Slice []uint"]
			["type","v.io/veyron/veyron2/vom.OuterMap map[uint]Slice"]
	...
	},
	{
		...
		//                     (StructType.Name) "v.io/veyron/veyron2/vom.Struct"
		// 00                (StructType end)
		//
		// ff82 03           type 65[ff82] len[03]
		//   01 01             (Struct.A) 1[01]
		...
		"ff811e180101013101014100" +
			...
			"ff8203010100",
		`["type","v.io/veyron/veyron2/vom.Struct struct{A uint}"]
			["Struct",{"A":1}]
			`,
		j{`{"a": 1}`},
	},
	...
	},
	{
		...
		//                     (StructType.Name) "v.io/veyron/veyron2/vom.OuterStruct"
		// 00                (StructType end)
		//
		// ff83 17           typedef 66[ff83] len[17]
		// 12                (SliceType)
		...
		"ff8123180101014201015300" +
			...
			"ff82050102050600",
		`["type","v.io/veyron/veyron2/vom.Slice []uint"]
			["type","v.io/veyron/veyron2/vom.OuterStruct struct{S Slice}"]
			["OuterStruct",{"S":[5,6]}]
			`,
		j{`{"s":[5,6]}`},
	},
	{
		...
		//                     (StructType.Name) "v.io/veyron/veyron2/vom.PtrStruct"
		// 00                (StructType end)
		//
		...
		"ff8121180101014201014100" +
			...
			"ff83041a013100" +
			"ff820401010100",
		`["type","v.io/veyron/veyron2/vom.PtrStruct struct{A *uint}"]
			["PtrStruct",{"A":[1,1]}]
			`,
		nil,
	},
	...
	// zero valued fields are skipped in the value.
	{
		...
		//                     (StructType.Name) "v.io/veyron/veyron2/vom.PartialStruct"
		// 00                (StructType end)
		//
		// ff82 03           type 65[ff82] len[03]
		...
		"ff812b180102013101014100013101014200" +
			...
			"ff8203020500",
		`["type","v.io/veyron/veyron2/vom.PartialStruct struct{A uint;B uint}"]
			["PartialStruct",{"B":5}]
			`,
		j{`{"b": 5}`},
	},
	// Recursive types also work.
	{
		...
		//                     (StructType.Name) "v.io/veyron/veyron2/vom.Recurse"
		// 00                (StructType end)
		//
		// ff83 04           typedef 66[ff83] len[04]
		// 1a                (PtrType)
		...
		`["type","v.io/veyron/veyron2/vom.Recurse struct{U uint;R *Recurse}"]
			["Recurse",{"U":1,"R":[1,{"U":2}]}]
			`,
		nil},
	{
		...
		nil},
	{
		...
		//                     (StructType.Name) "v.io/veyron/veyron2/vom.RecurseA"
		// 00                (StructType end)
		//
		// ff83 04           typedef 66[ff83] len[04]
		// 1a                (PtrType)
		...
		//                     (StructType.Name) "v.io/veyron/veyron2/vom.RecurseB"
		// 00                (StructType end)
		//
		...
		"ff812718010201310102556100014201014200" +
			...
			"ff87041a014100" +
			"ff82080101010101020000",
		`["type","v.io/veyron/veyron2/vom.RecurseB struct{Ub uint;A *veyron2/vom.RecurseA}"]
			["type","v.io/veyron/veyron2/vom.RecurseA struct{Ua uint;B *RecurseB}"]
	...
	// Tests of user-defined VomEncode and VomDecode methods.
	{
		...
		//                     (NamedPrimitiveType.Name) "v.io/veyron/veyron2/vom.UserCoder"
		// 00                (NamedPrimitiveType end)
		//
		...
		"ff811b100103" +
			...
			"ff82020139",
		`["type","v.io/veyron/veyron2/vom.UserCoder string"]
			["UserCoder","9"]
			`,
		nil},
	{
		...
		nil},
	{
		...
		//                     (NamedPrimitiveType.Name) "v.io/veyron/veyron2/vom.UserCoderPtrEncode"
		// 00                (NamedPrimitiveType end)
		//
		// ff82 03 01 01 39  type 65[ff82] len[03] refdef 1[01] value "9"[0139]
		"UserCoderPtrEncode",
		...
		"ff81041a014200" +
			...
			"ff8203010139",
		`["type","v.io/veyron/veyron2/vom.UserCoderPtrEncode string"]
		...
		nil},
	{
		...
		//                     (PtrType.Name) "v.io/veyron/veyron2/vom.UserCoderPtrType"
		// 00                (PtrType end)
		//
		// ff82 03 01 01 39  type 65[ff82] len[03] refdef 1[01] value "9"[0139]
		"UserCoderPtrType",
		...
		"ff81221a0103" +
			...
			"ff8203010139",
		`["type","v.io/veyron/veyron2/vom.UserCoderPtrType *string"]
	...
	// Tests of user-defined Gob / JSON coder methods.
	{
		...
		//                     (NamedPrimitiveType.Name) "v.io/veyron/veyron2/vom.UserCoderGobJSON"
		// 00                (NamedPrimitiveType end)
		//
		// ff82 03 01 01 39  type 65[ff82] len[03] refdef 1[01] value "9"[0139]
		"UserCoderGobJSON",
		...
		"ff81041a014200" +
			...
			"ff8203010139",
		`["type","v.io/veyron/veyron2/vom.UserCoderGobJSON string"]
	...
	*/
	{
		...
		//                     (StructType.Name) "v.io/veyron/veyron2/vom.Complex64"
		//   01 01 09 636f6d706c65783634
		//                     (StructType.Tags) []{"complex64"}
		// 00                (StructType end)
		//
		...
		"ff8133180102011901015200011901014900" +
			...
			"010109636f6d706c6578363400" +
			"ff820701fef03f014000",
		`["type","v.io/veyron/veyron2/vom.Complex64 struct{R float32;I float32}",["complex64"]]
	["Complex64",{"R":1,"I":2}]
	`,
		nil},
	...
	*/
	{
		...
		//                     (StructType.Name) "v.io/veyron/veyron2/vom.Complex128"
		//   01 01 0a 636f6d706c6578313238
		//                     (StructType.Tags) []{"complex128"}
		// 00                (StructType end)
		//
		...
		"ff8135180102011a01015200011a01014900" +
			...
			"01010a636f6d706c657831323800" +
			"ff820701fef03f014000",
		`["type","v.io/veyron/veyron2/vom.Complex128 struct{R float64;I float64}",["complex128"]]
		["Complex128",{"R":1,"I":2}]
		`,
		nil},
		...
		`, nil},
	{
		...
		//                     (StructType.Name) "v.io/veyron/veyron2/vom.NestedInterface"
		// 00                (StructType end)
		//
		// ff83 1e           typedef 66[ff83] len[1e]
		// 18                (StructType)
		...
		`["type","v.io/veyron/veyron2/vom.NestedInterface struct{I interface}"]
		["type","v.io/veyron/veyron2/vom.Struct struct{A uint}"]
	...
	},
	{
		...
		//                     (NamedPrimitiveType.Name) "v.io/veyron/veyron2/vom.Fooer"
		// 00                (NamedPrimitiveType end)
		//
		...
		//                     (NamedPrimitiveType.Name) "v.io/veyron/veyron2/vom.ConcreteFoo"
		// 00                (NamedPrimitiveType end)
		//
		// ff82 04           type 65[ff82] len[04]
		...
		"ff81041a014200" +
			...
			"ff820401ff8606",
		`["type","v.io/veyron/veyron2/vom.Fooer interface"]
		["type","v.io/veyron/veyron2/vom.ConcreteFoo int"]
	...
	// Byte slices and arrays.
	{
		...
		//                     (NamedPrimitiveType.Name) "v.io/veyron/veyron2/vom.ByteSlice"
		// 00                (NamedPrimitiveType end)
		//
		...
		"ff811b1001040115766579726f6e322f766f6d2e42797465536c69636500" +
			"ff820403616263",
		`["type","v.io/veyron/veyron2/vom.ByteSlice []byte"]
		["ByteSlice","YWJj"]
		`,
		j{`[97,98,99]`},
	},
	{
		...
		//                     (SliceType.Name) "v.io/veyron/veyron2/vom.NamedByteSlice"
		// 00                (SliceType end)
		//
		...
		//                     (NamedPrimitiveType.Name) "v.io/veyron/veyron2/vom.Byte"
		// 00                (NamedPrimitiveType end)
		//
		// ff82 04 03616263  type 65[ff82] len[04] value "abc"[03616263]
		"NamedByteSlice",
		...
		"ff8120120142011a766579726f6e322f766f6d2e4e616d656442797465536c69636500" +
			...
			"ff820403616263",
		`["type","v.io/veyron/veyron2/vom.Byte byte"]
		["type","v.io/veyron/veyron2/vom.NamedByteSlice []Byte"]
		["NamedByteSlice","YWJj"]
		`,
		j{`[97,98,99]`},
	},
	{
		...
		//                     (ArrayType.Name) "v.io/veyron/veyron2/vom.ByteArray"
		// 00                (ArrayType end)
		//
		...
		"ff811d14013201030115766579726f6e322f766f6d2e42797465417272617900" +
			"ff8203616263",
		`["type","v.io/veyron/veyron2/vom.ByteArray [3]byte"]
		["ByteArray","YWJj"]
		`,
		j{`[97,98,99]`},
	},
	{
		...
		//                     (ArrayType.Name) "v.io/veyron/veyron2/vom.NamedByteArray"
		// 00                (ArrayType end)
		//
		// ff83 16           typedef 66[ff82] len[16]
		// 10                (NamedPrimitiveType)
		...
		"ff81221401420103" +
			...
			"ff8203616263",
		`["type","v.io/veyron/veyron2/vom.Byte byte"]
		["type","v.io/veyron/veyron2/vom.NamedByteArray [3]Byte"]
		["NamedByteArray","YWJj"]
		`,
		j{`[97,98,99]`},
	},
	...
	// unescaping logic.
	{
		...
		//                     (MapType.Name) "v.io/veyron/veyron2/vom.MultiStringKeyMap"
		// 00                (MapType end)
		//
		...
		`["type","v.io/veyron/veyron2/vom.MultiStringKeyMap map[[2]string]string"]
