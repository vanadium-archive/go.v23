...
// is based on the package path, e.g. "veyron.io/veyron/veyron/lib/vom.StructType".  Type
...
func fullName(rt Type) string {
	if rt.Name() != "" {
		if rt.PkgPath() != "" {
			// The name is "pkgpath.name", e.g. "veyron.io/veyron/veyron/lib/vom.MapType"
...
//   "veyron.io/veyron/veyron/lib/vom.Type" -> ["Type", "vom.Type", "veyron.io/veyron/veyron/lib/vom.Type"]
//   "veyron.io/veyron/veyron.Type"         -> ["Type", "veyron.io/veyron/veyron.Type"]
//   "Type"                -> ["Type"]
//
