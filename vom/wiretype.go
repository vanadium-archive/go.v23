...
// is based on the package path, e.g. "v.io/veyron/veyron/lib/vom.StructType".  Type
...
func fullName(rt Type) string {
	if rt.Name() != "" {
		if rt.PkgPath() != "" {
			// The name is "pkgpath.name", e.g. "v.io/veyron/veyron/lib/vom.MapType"
...
//   "v.io/veyron/veyron/lib/vom.Type" -> ["Type", "vom.Type", "v.io/veyron/veyron/lib/vom.Type"]
//   "v.io/veyron/veyron.Type"         -> ["Type", "v.io/veyron/veyron.Type"]
//   "Type"                -> ["Type"]
//
