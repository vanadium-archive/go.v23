// Package idltest provides testing utilities for veyron2/idl2/...
package idltest
...
func ExpectPass(t *testing.T, errs *idl2.Errors, testName string) {
	if !errs.IsEmpty() {
...
func ExpectFail(t *testing.T, errs *idl2.Errors, testName string, re ...string) {
	if errs.IsEmpty() {
...
func ExpectResult(t *testing.T, errs *idl2.Errors, testName string, re ...string) {
