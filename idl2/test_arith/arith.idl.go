...
type Arith_InternalNoTagGetter interface {
	...
	QuoteAny(a _gen_idl2.Any, opts ..._gen_ipc.ClientCallOpt) (reply _gen_idl2.Any, err error)
}
...
type ArithService interface {
	...
	// QuoteAny shows the any built-in type, representing a value of any type.
	QuoteAny(context _gen_ipc.Context, a _gen_idl2.Any) (reply _gen_idl2.Any, err error)
}
...
func (__gen_c *clientStubArith) QuoteAny(a _gen_idl2.Any, opts ..._gen_ipc.ClientCallOpt) (reply _gen_idl2.Any, err error) {
	var call _gen_ipc.ClientCall
...
func (__gen_s *ServerStubArith) QuoteAny(call _gen_ipc.ServerCall, a _gen_idl2.Any) (reply _gen_idl2.Any, err error) {
