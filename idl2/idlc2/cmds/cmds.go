...
`,
	...
	// Common flags for the tool itself, applicable to all commands.
	idlc.Flags.BoolVar(&flagVerbose, "v", false, "Turn on verbose logging.")
	idlc.Flags.IntVar(&flagMaxErrors, "max_errors", -1, "Stop processing after this many errors, or -1 for unlimited.")
