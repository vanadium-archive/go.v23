...
// genJavaClassFile generates the Java class file for the provided user-defined type.
...
func genJavaListFile(tdef *compile.TypeDef, env *compile.Env) JavaFileInfo {
	...
	var buf bytes.Buffer
	err := javaListTmpl.Execute(&buf, data)
	if err != nil {
...
const javaListTmplStr = `// This file was auto-generated by the veyron vdl tool.
// Source: {{.SourceFile}}
package {{.Package}};
 ...
 **/
public final class {{.Type}} implements List<{{.ElemType}}> {
	private List<{{.ElemType}}> impl;

	public {{.Type}}(List<{{.ElemType}}> impl) {
		this.impl = impl;
	}
	public List<{{.ElemType}}> getValue() { return this.impl; }

	public void setValue(List<{{.ElemType}}> newImpl) {
	    this.impl = newImpl;
	}
    ...
    @Override
    public boolean addAll(int location, Collection<? extends {{.ElemType}}> collection) {
        return impl.addAll(location, collection);
    }
    @Override
    public boolean addAll(Collection<? extends {{.ElemType}}> collection) {
    ...
    @Override
    public ListIterator<{{.ElemType}}> listIterator(int location) {
    ...
    @Override
    public List<{{.ElemType}}> subList(int start, int end) {
...
func genJavaArrayFile(tdef *compile.TypeDef, env *compile.Env) JavaFileInfo {
	...
	var buf bytes.Buffer
	err := javaArrayTmpl.Execute(&buf, data)
	if err != nil {
...
const javaArrayTmplStr = `// This file was auto-generated by the veyron vdl tool.
// Source: {{.SourceFile}}
...
public final class {{.Type}} implements List<{{.ElemType}}> {
    ...
    private FixedLengthList<{{.ElemType}}> impl;
    ...
    public void setValue({{.ElemType}}[] arr) {
        ...
        this.impl = new FixedLengthList<{{.ElemType}}>(arr);
    }
...
func genJavaSetFile(tdef *compile.TypeDef, env *compile.Env) JavaFileInfo {
	...
	var buf bytes.Buffer
	err := javaSetTmpl.Execute(&buf, data)
	if err != nil {
...
const javaSetTmplStr = `// This file was auto-generated by the veyron vdl tool.
// Source: {{.SourceFile}}
 ...
 **/
public final class {{.Type}} implements Set<{{.KeyType}}> {
    private Set<{{.KeyType}}> impl;

    public {{.Type}}(Set<{{.KeyType}}> impl) {
        this.impl = impl;
    }

    public Set<{{.KeyType}}> getValue() {
        return this.impl;
    }

    public void setValue(Set<{{.KeyType}}> newImpl) {
        this.impl = newImpl;
    }
    ...
    @Override
    public boolean addAll(Collection<? extends {{.KeyType}}> collection) {
        return impl.addAll(collection);
    }
...
func genJavaMapFile(tdef *compile.TypeDef, env *compile.Env) JavaFileInfo {
	...
	var buf bytes.Buffer
	err := javaMapTmpl.Execute(&buf, data)
	if err != nil {
...
const javaMapTmplStr = `// This file was auto-generated by the veyron vdl tool.
// Source: {{.SourceFile}}
 ...
 * type {{.Type}} {{.VdlTypeString}} {{.Doc}}
 **/
public final class {{.Type}} implements Map<{{.KeyType}}, {{.ElemType}}> {
    private Map<{{.KeyType}}, {{.ElemType}}> impl;

    public {{.Type}}(Map<{{.KeyType}}, {{.ElemType}}> impl) {
        this.impl = impl;
    }

    public Map<{{.KeyType}}, {{.ElemType}}> getValue() {
        return this.impl;
    }

    public void setValue(Map<{{.KeyType}}, {{.ElemType}}> newImpl) {
        this.impl = newImpl;
    }
    ...
    @Override
    public Set<java.util.Map.Entry<{{.KeyType}}, {{.ElemType}}>> entrySet() {
        return impl.entrySet();
    }

    @Override
    public {{.ElemType}} get(Object key) {
        return impl.get(key);
    }
    ...
    @Override
    public void putAll(Map<? extends {{.KeyType}}, ? extends {{.ElemType}}> map) {
        impl.putAll(map);
    }

    @Override
    public {{.ElemType}} remove(Object key) {
...
// javaQualifiedName returns the fully qualified Java name for the provided goName.
...
var (
	...
	javaListTmpl           *template.Template
	javaArrayTmpl          *template.Template
	javaSetTmpl            *template.Template
	javaMapTmpl            *template.Template
...
func init() {
	...
	javaListTmpl = template.Must(template.New("javaList").Funcs(funcMap).Parse(javaListTmplStr))
	javaArrayTmpl = template.Must(template.New("javaArray").Funcs(funcMap).Parse(javaArrayTmplStr))
	javaSetTmpl = template.Must(template.New("javaSet").Funcs(funcMap).Parse(javaSetTmplStr))
	javaMapTmpl = template.Must(template.New("javaMap").Funcs(funcMap).Parse(javaMapTmplStr))
