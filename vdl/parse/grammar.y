...
//
// The differences between VDL and Go syntax:
//   * VDL specifies APIs via types, interfaces and error ids.  You don't
//     specify implementation.
//   * VDL doesn't consider an interface to be a type; you can't use an
//     interface as the type of a function argument.
//     TODO(toddw): Work out the semantics and change this.
//   * VDL numeric constant definitions are always typed; it would be annoying
//     to support untyped constants across different languages.  There is no
//     iota identifier.
//   * VDL methods may be optionally tagged with a list of const values.
//   * VDL allows error ids to be defined that work across address spaces and
//     languages.
//
