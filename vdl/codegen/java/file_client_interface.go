...
{{ range $method := .Methods }}
    ...
    {{ $method.Doc }}
    public {{ $method.RetType }} {{ $method.Name }}(final io.veyron.veyron.veyron2.context.Context context{{ $method.Args }}) throws io.veyron.veyron.veyron2.VeyronException;
    public {{ $method.RetType }} {{ $method.Name }}(final io.veyron.veyron.veyron2.context.Context context{{ $method.Args }}, final io.veyron.veyron.veyron2.Options veyronOpts) throws io.veyron.veyron.veyron2.VeyronException;
{{ end }}
}
`
