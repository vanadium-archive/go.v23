...
{{ range $method := .Methods }}
    ...
    {{ $method.Doc }}
    {{ $method.AccessModifier }} {{ $method.RetType }} {{ $method.Name }}(final io.v.core.veyron2.context.VContext context{{ $method.Args }}) throws io.v.core.veyron2.verror2.VException;
    {{ $method.AccessModifier }} {{ $method.RetType }} {{ $method.Name }}(final io.v.core.veyron2.context.VContext context{{ $method.Args }}, final io.v.core.veyron2.Options veyronOpts) throws io.v.core.veyron2.verror2.VException;
{{ end }}
}
`
