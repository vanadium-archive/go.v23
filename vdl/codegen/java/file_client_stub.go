...
{{ .AccessModifier }} final class {{ .ServiceName }}ClientStub implements {{ .FullServiceName }}Client {
    ...
    private io.v.core.veyron2.ipc.Client getClient(io.v.core.veyron2.context.VContext context) {
        return this.client != null ? client : io.v.core.veyron2.V.getClient(context);
    ...
    //@Override
    //public io.v.core.veyron2.ipc.ServiceSignature getSignature(io.v.core.veyron2.context.VContext context) throws io.v.core.veyron2.verror.VException {
    //    return getSignature(context, null);
    //}
    //@Override
    //public io.v.core.veyron2.ipc.ServiceSignature getSignature(io.v.core.veyron2.context.VContext context, io.v.core.veyron2.Options veyronOpts) throws io.v.core.veyron2.verror.VException {
    //    // Start the call.
...
{{ range $method := .Methods }}
    ...
    @Override
    {{ $method.AccessModifier }} {{ $method.RetType }} {{ $method.Name }}(final io.v.core.veyron2.context.VContext context{{ $method.DeclarationArgs }}) throws io.v.core.veyron2.verror.VException {
        {{if $method.Returns }}return{{ end }} {{ $method.Name }}(context{{ $method.CallingArgsLeadingComma }}, null);
    }
    {{/* The main client stub method body */}}
    @Override
    {{ $method.AccessModifier }} {{ $method.RetType }} {{ $method.Name }}(final io.v.core.veyron2.context.VContext context{{ $method.DeclarationArgs }}, io.v.core.veyron2.Options veyronOpts) throws io.v.core.veyron2.verror.VException {
        ...
        final io.v.core.veyron2.ipc.Client.Call _call = getClient(context).startCall(context, this.veyronName, "{{ $method.Name }}", _args, _argTypes, veyronOpts);
        ...
        return new io.v.core.veyron2.vdl.ClientStream<{{ $method.SendType }}, {{ $method.RecvType }}, {{ $method.DeclaredObjectRetType }}>() {
            @Override
            public void send(final {{ $method.SendType }} item) throws io.v.core.veyron2.verror.VException {
            ...
            @Override
            public {{ $method.DeclaredObjectRetType }} finish() throws io.v.core.veyron2.verror.VException {
                {{ if $method.IsVoid }}
...
{{ range $eMethod := .EmbedMethods }}
    @Override
    {{ $eMethod.AccessModifier }} {{ $eMethod.RetType }} {{ $eMethod.Name }}(final io.v.core.veyron2.context.VContext context{{ $eMethod.DeclarationArgs }}) throws io.v.core.veyron2.verror.VException {
    ...
    @Override
    {{ $eMethod.AccessModifier }} {{ $eMethod.RetType }} {{ $eMethod.Name }}(final io.v.core.veyron2.context.VContext context{{ $eMethod.DeclarationArgs }}, io.v.core.veyron2.Options veyronOpts) throws io.v.core.veyron2.verror.VException {
