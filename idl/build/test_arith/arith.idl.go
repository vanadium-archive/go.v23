...
type CrossPkg struct {
	// A docs
	A test_base.MyInt2 // more A docs
	// B docs
	B test_base.MyArray2 // more B docs
	C test_base.MySlice2 // C docs
	// D docs
	D test_base.MyMap2
	E test_base.Args2      // E docs
	F test_base.NestedArgs // F docs
	/* G docs */
	G test_base.Args /* more G docs */
	H test_base.MyInt
	I test_base.MyArray
	J test_base.MySlice
	K test_base.MyMap
	L _gen_idl.AnyData // Make sure anydata works in a struct
}
...
const ErrIDFoo = _gen_verror.ID("veyron2/idl/build/test_arith.ErrIDFoo")

// ErrIDBar overrides the id to be the same as ErrIDFoo.
const ErrIDBar = _gen_verror.ID("veyron2/internal/lib/idl/test_arith.ErrIDFoo")
...
type Arith_InternalNoTagGetter interface {
	...
	// just like Go.
	DivMod(A int32, B int32, opts ..._gen_ipc.ClientCallOpt) (Quot int32, Remain int32, err error)
	...
	Mul(nestedArgs test_base.NestedArgs, opts ..._gen_ipc.ClientCallOpt) (reply int32, err error)
	...
	QuoteAny(Any _gen_idl.AnyData, opts ..._gen_ipc.ClientCallOpt) (reply _gen_idl.AnyData, err error)
}
...
type ArithService interface {
	...
	// DivMod shows that runs of args with the same type can use the short form,
	// just like Go.
	DivMod(context _gen_ipc.Context, A int32, B int32) (Quot int32, Remain int32, err error)

	// Sub shows that you can use data types defined in other packages.
	Sub(context _gen_ipc.Context, args test_base.Args) (reply int32, err error)

	// Mul tries another data type defined in another package.
	Mul(context _gen_ipc.Context, nestedArgs test_base.NestedArgs) (reply int32, err error)
	...
	// veyron/api/idl, with underlying type "interface{}".  For other generated
	// languages you get an object with similar semantics.
	QuoteAny(context _gen_ipc.Context, Any _gen_idl.AnyData) (reply _gen_idl.AnyData, err error)
}
...
func (__gen_c *clientStubArith) DivMod(A int32, B int32, opts ..._gen_ipc.ClientCallOpt) (Quot int32, Remain int32, err error) {
	var call _gen_ipc.ClientCall
	if call, err = __gen_c.client.StartCall(__gen_c.name, "DivMod", []interface{}{A, B}, opts...); err != nil {
		return
	}
	if ierr := call.Finish(&Quot, &Remain, &err); ierr != nil {
		err = ierr
	}
	return
}
...
func (__gen_c *clientStubArith) Mul(nestedArgs test_base.NestedArgs, opts ..._gen_ipc.ClientCallOpt) (reply int32, err error) {
	var call _gen_ipc.ClientCall
	if call, err = __gen_c.client.StartCall(__gen_c.name, "Mul", []interface{}{nestedArgs}, opts...); err != nil {
		return
	}
	if ierr := call.Finish(&reply, &err); ierr != nil {
		err = ierr
...
func (__gen_c *clientStubArith) QuoteAny(Any _gen_idl.AnyData, opts ..._gen_ipc.ClientCallOpt) (reply _gen_idl.AnyData, err error) {
	var call _gen_ipc.ClientCall
	if call, err = __gen_c.client.StartCall(__gen_c.name, "QuoteAny", []interface{}{Any}, opts...); err != nil {
		return
	}
	if ierr := call.Finish(&reply, &err); ierr != nil {
		err = ierr
...
func (s *ServerStubArith) Signature(call _gen_ipc.ServerCall) (_gen_ipc.ServiceSignature, error) {
	...
	result.TypeDefs = []_gen_idl.AnyData{
		...
		_gen_wiretype.StructType{
			[]_gen_wiretype.FieldType{
				_gen_wiretype.FieldType{Type: 0x43, Name: "Args"},
			},
			"base.NestedArgs", []string(nil)},
...
func (__gen_s *ServerStubArith) DivMod(call _gen_ipc.ServerCall, A int32, B int32) (Quot int32, Remain int32, err error) {
	Quot, Remain, err = __gen_s.service.DivMod(call, A, B)
	return
}
...
func (__gen_s *ServerStubArith) Mul(call _gen_ipc.ServerCall, nestedArgs test_base.NestedArgs) (reply int32, err error) {
	reply, err = __gen_s.service.Mul(call, nestedArgs)
	return
}
...
func (__gen_s *ServerStubArith) QuoteAny(call _gen_ipc.ServerCall, Any _gen_idl.AnyData) (reply _gen_idl.AnyData, err error) {
	reply, err = __gen_s.service.QuoteAny(call, Any)
	return
}
...
func GetArithMethodTags(method string) []interface{} {
	...
	case "Mul":
		return []interface{}{}
	case "GenError":
		return []interface{}{"foo", TagString("barz"), TagString("hello"), TagInt32(129)}
	case "Count":
		return []interface{}{}
	case "StreamingAdd":
		return []interface{}{}
...
type Calculator_InternalNoTagGetter interface {
	...
	Arith_InternalNoTagGetter // Arith provides the interface to basic arithmetic operations.
...
type CalculatorService interface {
	...
	// A calculator can do basic arithmetic.
	ArithService // Arith provides the interface to basic arithmetic operations.
