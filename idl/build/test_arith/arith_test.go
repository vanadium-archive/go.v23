...
func (*serverArith) QuoteAny(_ ipc.Context, any idl.AnyData) (idl.AnyData, error) {
...
func TestCalculator(t *testing.T) {
	...
	tagTests := []struct {
		...
		{"GenError", []interface{}{"foo", TagString("barz"), TagString("hello"), TagInt32(129)}},
...
func TestArith(t *testing.T) {
	...
	for i, disp := range dispatchers {
		...
		expectedTags := []interface{}{"foo", TagString("barz"), TagString("hello"), TagInt32(129)}
